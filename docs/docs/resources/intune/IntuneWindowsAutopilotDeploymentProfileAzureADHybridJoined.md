...
| --- | --- | --- | --- | --- |
| **HybridAzureADJoinSkipConnectivityCheck** | Write | Boolean | The Autopilot Hybrid Entra ID join flow will continue even if it does not establish domain controller connectivity during OOBE. | |
