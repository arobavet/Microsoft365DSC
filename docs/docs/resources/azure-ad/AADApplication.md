...
| **IdentifierUris** | Write | StringArray[] | User-defined URI(s) that uniquely identify a Web application within its Entra ID tenant, or within a verified custom domain. | |
