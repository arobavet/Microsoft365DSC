...
Export-M365DSCConfiguration -Components @("AADAuthenticationMethodPolicy", "AADSecurityDefaults","AADAuthorizationPolicy") -Credential $Credential -Path "C:\Users\tbouchet\Downloads\Test"
