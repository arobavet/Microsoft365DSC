function Get-TargetResource
{
    ...
    try
    {
        ...
        {
            Write-Verbose -Message "Could not find an Entra ID Authentication Method Policy Sms with id {$id}"
            return $nullResult
        }
        $Id = $getValue.Id
        Write-Verbose -Message "An Entra ID Authentication Method Policy Sms with Id {$Id} was found."
...
function Set-TargetResource
{
    ...
    {
        Write-Verbose -Message "Updating the Entra ID Authentication Method Policy Sms with Id {$($currentInstance.Id)}"
    ...
    {
        Write-Verbose -Message "Removing the Entra ID Authentication Method Policy Sms with Id {$($currentInstance.Id)}"
        #region resource generator code
...
function Test-TargetResource
{
    ...
    Write-Verbose -Message "Testing configuration of the Entra ID Authentication Method Policy Sms with Id {$Id}"
